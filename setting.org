...
** org-mode
   ...
   #+RESULTS:
   | a | Agenda for work | ((agenda  ((org-agenda-skip-function (quote (org-agenda-skip-entry-if (quote nottodo) (quote (TODO DONE))))))) (todo NOTE ((org-agenda-skip-function (quote skip-item-by-closed-in-two-weeks)))) (todo LATER) (alltodo  ((org-agenda-skip-function (quote (org-agenda-skip-entry-if (quote scheduled))))))) |
   | n | todo            | NOTE                                                                                                                                                                                                                                                                                                        |

   there is my personal org-mode workflow
...
** web-mode
   #+BEGIN_SRC emacs-lisp
     ...
     (defun setup-web-mode-company-mode ()
       (setq-local
        company-backends
        '(company-files company-dabbrev company-yasnippet company-keywords company-css company-tabnine)))
